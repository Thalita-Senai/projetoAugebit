  ...
  <div class="container">
    ...
    <div class="content">
      <div class="steps">
        ...
        <a href="modalEstoqueTres.php" class="step-dot"></a>
      </div>

      <div class="title">Quantidade em estoque</div>
      <div class="descricao">
        <div class="coiso">
        ...
        <div class="coiso2">
          <img src="../img/icons/retirada_icon.png" alt="" class="icone2">
          <input type="text" class="texto" placeholder="42">
          <p class="subtexto">Quantidade Retirada</p>
        </div>
        <div class="coiso3">
          <img src="../img/icons/estatistica_icon.png" alt="" class="icone3">
          <p class="textin">Média</p>
          <p class="subtexto2">Demanda</p>
        </div>
      </div>
